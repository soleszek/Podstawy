...
public class Bicycle extends Vehicle {
    ...
    public Bicycle(int speed, int maxSpeed, int wheelCount, int rozmiarKol, int liczbaPrzerzutek) {
    ...
    public String toString() {
        return super.toString() + " Rozmiar kół wynosi: " + rozmiarKol + " liczba przerzutek wynosi: " + liczbaPrzerzutek;
    }
